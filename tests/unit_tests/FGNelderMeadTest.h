...
/***************************************************************************
 * Final Nelder-Mead Tests (Tests 76-100)
 ***************************************************************************/

class FGNelderMeadFinalTest : public CxxTest::TestSuite {
public:
    void testBealeFunctionOpt() { BealeFunction func; std::vector<double> guess={0.0,0.0}; std::vector<double> lower={-4.5,-4.5}; std::vector<double> upper={4.5,4.5}; std::vector<double> step={0.5,0.5}; FGNelderMead optimizer(&func,guess,lower,upper,step,3000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],3.0,0.1); TS_ASSERT_DELTA(solution[1],0.5,0.1); }
    void testBoothFunctionOpt() { BoothFunction func; std::vector<double> guess={0.0,0.0}; std::vector<double> lower={-10.0,-10.0}; std::vector<double> upper={10.0,10.0}; std::vector<double> step={1.0,1.0}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],1.0,0.01); TS_ASSERT_DELTA(solution[1],3.0,0.01); }
    void testMatyasFunctionOpt() { MatyasFunction func; std::vector<double> guess={5.0,-3.0}; std::vector<double> lower={-10.0,-10.0}; std::vector<double> upper={10.0,10.0}; std::vector<double> step={1.0,1.0}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],0.0,0.01); TS_ASSERT_DELTA(solution[1],0.0,0.01); }
    void testSphere3DFunctionOpt() { Sphere3DFunction func; std::vector<double> guess={2.0,3.0,-1.0}; std::vector<double> lower={-10.0,-10.0,-10.0}; std::vector<double> upper={10.0,10.0,10.0}; std::vector<double> step={0.5,0.5,0.5}; FGNelderMead optimizer(&func,guess,lower,upper,step,3000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); for(double xi:solution)TS_ASSERT_DELTA(xi,0.0,0.01); }
    void testShiftedSphere3D() { ShiftedSphere3DFunction func; std::vector<double> guess={0.0,0.0,0.0}; std::vector<double> lower={-10.0,-10.0,-10.0}; std::vector<double> upper={10.0,10.0,10.0}; std::vector<double> step={0.5,0.5,0.5}; FGNelderMead optimizer(&func,guess,lower,upper,step,3000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],1.0,0.01); TS_ASSERT_DELTA(solution[1],2.0,0.01); TS_ASSERT_DELTA(solution[2],3.0,0.01); }
    void testSphere4DFunctionOpt() { Sphere4DFunction func; std::vector<double> guess={1.0,2.0,-1.0,0.5}; std::vector<double> lower={-5.0,-5.0,-5.0,-5.0}; std::vector<double> upper={5.0,5.0,5.0,5.0}; std::vector<double> step={0.5,0.5,0.5,0.5}; FGNelderMead optimizer(&func,guess,lower,upper,step,5000,1e-8,1e-6,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_EQUALS(solution.size(),4u); for(double xi:solution)TS_ASSERT_DELTA(xi,0.0,0.1); }
    void testSumOfSquaresOpt() { SumOfSquaresFunction func; std::vector<double> guess={1.0,2.0,3.0}; std::vector<double> lower={-5.0,-5.0,-5.0}; std::vector<double> upper={5.0,5.0,5.0}; std::vector<double> step={0.5,0.5,0.5}; FGNelderMead optimizer(&func,guess,lower,upper,step,3000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); for(double xi:solution)TS_ASSERT_DELTA(xi,0.0,0.01); }
    void testParabola1D() { ParabolaFunction func; std::vector<double> guess={5.0}; std::vector<double> lower={-10.0}; std::vector<double> upper={10.0}; std::vector<double> step={1.0}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],0.0,0.01); }
    void testQuadratic2D() { Quadratic2DFunction func; std::vector<double> guess={3.0,4.0}; std::vector<double> lower={-10.0,-10.0}; std::vector<double> upper={10.0,10.0}; std::vector<double> step={0.5,0.5}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],0.0,0.01); TS_ASSERT_DELTA(solution[1],0.0,0.01); }
    void testWideStepConvergence() { ParabolaFunction func; std::vector<double> guess={8.0}; std::vector<double> lower={-10.0}; std::vector<double> upper={10.0}; std::vector<double> step={3.0}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],0.0,0.1); }
    void testLargeStepParabola() { ParabolaFunction func; std::vector<double> guess={5.0}; std::vector<double> lower={-10.0}; std::vector<double> upper={10.0}; std::vector<double> step={5.0}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],0.0,0.1); }
    void testSmallStepParabola() { ParabolaFunction func; std::vector<double> guess={0.1}; std::vector<double> lower={-10.0}; std::vector<double> upper={10.0}; std::vector<double> step={0.01}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],0.0,0.01); }
    void testNarrowBoundsParabola() { ParabolaFunction func; std::vector<double> guess={0.5}; std::vector<double> lower={-2.0}; std::vector<double> upper={2.0}; std::vector<double> step={0.2}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],0.0,0.05); }
    void testLooseTolerance() { ParabolaFunction func; std::vector<double> guess={5.0}; std::vector<double> lower={-10.0}; std::vector<double> upper={10.0}; std::vector<double> step={1.0}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-4,1e-4,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],0.0,0.1); }
    void testEarlyTermination() { ParabolaFunction func; std::vector<double> guess={5.0}; std::vector<double> lower={-10.0}; std::vector<double> upper={10.0}; std::vector<double> step={1.0}; FGNelderMead optimizer(&func,guess,lower,upper,step,10,1e-15,1e-15,2.0,0.0,false,false,false,nullptr); int iterations=0; while(optimizer.status()>0&&iterations<100){optimizer.update();iterations++;} TS_ASSERT(iterations<=20); }
    void testStatusCheck() { ParabolaFunction func; std::vector<double> guess={5.0}; std::vector<double> lower={-10.0}; std::vector<double> upper={10.0}; std::vector<double> step={1.0}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); TS_ASSERT(optimizer.status()>0); while(optimizer.status()>0)optimizer.update(); TS_ASSERT(optimizer.status()<=0); }
    void testSolutionSizeConsistency() { Quadratic2DFunction func; std::vector<double> guess={1.0,2.0}; std::vector<double> lower={-5.0,-5.0}; std::vector<double> upper={5.0,5.0}; std::vector<double> step={0.5,0.5}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_EQUALS(solution.size(),2u); }
    void testConvergenceStabilityExt() { Quadratic2DFunction func; std::vector<double> guess={3.0,4.0}; std::vector<double> lower={-10.0,-10.0}; std::vector<double> upper={10.0,10.0}; std::vector<double> step={0.5,0.5}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution1=optimizer.getSolution(); for(int i=0;i<10;i++)optimizer.update(); std::vector<double> solution2=optimizer.getSolution(); TS_ASSERT_DELTA(solution1[0],solution2[0],1e-10); TS_ASSERT_DELTA(solution1[1],solution2[1],1e-10); }
    void testMultipleRunsSameResult() { ParabolaFunction func; std::vector<double> guess={5.0}; std::vector<double> lower={-10.0}; std::vector<double> upper={10.0}; std::vector<double> step={1.0}; FGNelderMead opt1(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(opt1.status()>0)opt1.update(); FGNelderMead opt2(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(opt2.status()>0)opt2.update(); TS_ASSERT_EQUALS(opt1.getSolution()[0],opt2.getSolution()[0]); }
    void testBealeFromDifferentStart() { BealeFunction func; std::vector<double> guess={2.0,1.0}; std::vector<double> lower={-4.5,-4.5}; std::vector<double> upper={4.5,4.5}; std::vector<double> step={0.5,0.5}; FGNelderMead optimizer(&func,guess,lower,upper,step,3000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],3.0,0.1); TS_ASSERT_DELTA(solution[1],0.5,0.1); }
    void testBoothFromCorner() { BoothFunction func; std::vector<double> guess={-10.0,-10.0}; std::vector<double> lower={-10.0,-10.0}; std::vector<double> upper={10.0,10.0}; std::vector<double> step={2.0,2.0}; FGNelderMead optimizer(&func,guess,lower,upper,step,3000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],1.0,0.1); TS_ASSERT_DELTA(solution[1],3.0,0.1); }
    void testMatyasFromFarStart() { MatyasFunction func; std::vector<double> guess={5.0,-5.0}; std::vector<double> lower={-10.0,-10.0}; std::vector<double> upper={10.0,10.0}; std::vector<double> step={1.0,1.0}; FGNelderMead optimizer(&func,guess,lower,upper,step,5000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],0.0,0.1); TS_ASSERT_DELTA(solution[1],0.0,0.1); }
    void testAsymmetricBoundsExt() { ParabolaFunction func; std::vector<double> guess={0.0}; std::vector<double> lower={-1.0}; std::vector<double> upper={5.0}; std::vector<double> step={0.5}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],0.0,0.01); }
    void testStartingAtMinimum() { ParabolaFunction func; std::vector<double> guess={0.0}; std::vector<double> lower={-10.0}; std::vector<double> upper={10.0}; std::vector<double> step={1.0}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],0.0,0.01); }
    void testNegativeStartParabola() { ParabolaFunction func; std::vector<double> guess={-7.0}; std::vector<double> lower={-10.0}; std::vector<double> upper={10.0}; std::vector<double> step={1.0}; FGNelderMead optimizer(&func,guess,lower,upper,step,2000,1e-10,1e-8,2.0,0.0,false,false,false,nullptr); while(optimizer.status()>0)optimizer.update(); std::vector<double> solution=optimizer.getSolution(); TS_ASSERT_DELTA(solution[0],0.0,0.01); }
};

...
class FGGroundEffectC172xTest : public CxxTest::TestSuite
{
public:
  void testC172xOnGround() {
    // Test C172x on ground initial conditions
    FGFDMExec fdmex;
  ...
  void testC172xAerodynamicForces() {
    // Test aerodynamic forces on ground
    FGFDMExec fdmex;
    fdmex.LoadModel("c172x");
    fdmex.RunIC();
  ...
  void testC172xDragCoefficient() {
    ...
    // Check L/D ratio is valid
    double ld = aero->GetLoD();
    TS_ASSERT(std::isfinite(ld));
  }

  void testC172xPitchMoment() {
    // Test pitch moment
    FGFDMExec fdmex;
    fdmex.LoadModel("c172x");
    fdmex.RunIC();
  ...
  void testC172xFlapEffect() {
    // Test flap effect near ground
    FGFDMExec fdmex;
    fdmex.LoadModel("c172x");
    fdmex.RunIC();
  ...
  void testC172xDynamicPressure() {
    // Test dynamic pressure on ground
    FGFDMExec fdmex;
    fdmex.LoadModel("c172x");
    fdmex.RunIC();
  ...
  void testC172xAltitudeAGL() {
    ...
    double agl = propagate->GetAltitudeASL();
    TS_ASSERT(std::isfinite(agl));
  }

  void testC172xVerticalSpeed() {
    // Test vertical speed near ground
    FGFDMExec fdmex;
    fdmex.LoadModel("c172x");
    fdmex.RunIC();
  ...
  void testC172xThrottleOnGround() {
    // Test throttle on ground
    FGFDMExec fdmex;
    fdmex.LoadModel("c172x");
